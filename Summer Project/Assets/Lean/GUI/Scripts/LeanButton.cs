...
namespace Lean.Gui
{
	...
	public class LeanButton_Inspector : LeanInspector<LeanButton>
	{
		protected override void DrawInspector()
		{
			...
			Draw("normalTransitions", "This event will be invoked when all pointers stop pressing down on this button.");
			Draw("downTransitions", "This event will be invoked when a pointer presses down on this button.");
...
namespace Lean.Gui
{
	...
	public class LeanButton : Selectable, IPointerDownHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, ISubmitHandler
	{
		...
		public bool MultiDown { set { multiDown = true; } get { return multiDown; } } [SerializeField] private bool multiDown;
